...
- 🎯 **Standard Test Suites** - Comprehensive pre-built test signals covering various scenarios
- 📊 **Real-time Analysis** - Live progress tracking with performance metrics
- 📈 **Visualization** - Detailed results with matplotlib charts
- 💾 **Export Results** - Save reports in JSON, markdown, and image formats
- 🎵 **Custom Audio** - Load and analyze your own audio files
- ⚡ **Performance Metrics** - Track frame processing times and efficiency
...
- Timing jitter: ±5ms, ±10ms, ±15ms variations
...
```
aubio-beatcheck/
├── aubio_beatcheck/          # Main application package
│   ├── core/                 # Core analysis functionality
│   │   ├── analyzers.py      # Aubio wrapper classes
...
├── src/                      # Legacy modules (to be migrated)
│   ├── thebeat_generator.py # TheBeat signal generation
